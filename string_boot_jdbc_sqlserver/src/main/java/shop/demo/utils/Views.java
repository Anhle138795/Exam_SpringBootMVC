...
public class Views {
    ...
    public static String TYPE_INDEX="type/index";
    public static String TYPE_CREATE="type/input_type";
    public static String TYPE_EDIT="type/edit_type";
    public static String CATEGORY_INDEX="categories/index";
    public static String CATEGORY_CREATE="categories/new_category";
    public static String CATEGORY_EDIT="categories/category_edit";
