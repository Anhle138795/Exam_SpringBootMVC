...
public class CustomerService {
    ...
    public Contracts getContractById(int contractId) {
        ...
        return jdbcTemplate.queryForObject(sql, new BeanPropertyRowMapper<>(Contracts.class), new Object[]{contractId});
    }
    ...
    public List<Contracts> findContractsByDuration(int duration) {
        ...
        return jdbcTemplate.query(sql, new BeanPropertyRowMapper<>(Contracts.class), new Object[]{duration});
    }
