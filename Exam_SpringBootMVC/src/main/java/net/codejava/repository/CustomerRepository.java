...
public class CustomerRepository {
    ...
    public List<Contracts> findContractsByCustomerId(int customerId) {
        ...
        return jdbcTemplate.query(sql, new BeanPropertyRowMapper<>(Contracts.class), new Object[]{customerId});
    }

    public List<Payments> findPaymentsByContractId(int contractId) {
        String sql = "SELECT * FROM Payments WHERE contract_id = ?";
        return jdbcTemplate.query(sql, new BeanPropertyRowMapper<>(Payments.class), new Object[]{contractId});
    }
